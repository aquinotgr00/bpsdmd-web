...
@section('content')
    <section class="content-header">
        <h1>{{ ucfirst(trans('common.edit')) }} {{ ucwords(trans('common.competency_main_purpose')) }}</h1>
    </section>
                    ...
                    <div class="box-body">
                        <form method="post">
                            ...
                            <div class="form-group {{ $errors->has('code') ? 'has-error' : '' }}">
                                ...
                                <input id="code" name="code" type="text" class="form-control" value="{{ $cmp->getCode() }}">
                                <span class="help-block">{!! implode('', $errors->get('code')) !!}</span>
                            </div>

                            <div class="form-group {{ $errors->has('text') ? 'has-error' : '' }}">
                                <label for="chapter">{{ ucfirst(trans('common.main_purpose')) }} :</label>
                                <textarea class="form-control" id="text" name="text" >{{ $cmp->getMainPurpose() }}</textarea>
