            ...
            <section class="col-lg-12 connectedSortable ui-sortable">
                ...
                <div class="box box-primary" id="loading-example">
                    <div class="box-header" style="cursor: move;">
                        ...
                        <i class="fa fa-bar-chart-o"></i>
                        <h3 class="box-title"> Grafik Taruna  Keseluruhan</h3>
                    </div><!-- /.box-header -->
                    <div class="box-body no-padding">
                        <div class="row">
                            <div class="col-sm-12">
            ...
            <div class="col-xs-12">
                <div class="box box-primary" id="loading-example">
                    <div class="box-header" style="cursor: move;">
                        ...
                        <h3 class="box-title">List Taruna  Keseluruhan</h3>
                    </div><!-- /.box-header -->
            ...
            <div class="col-xs-12">
                <div class="box box-primary" id="loading-example">
                    <div class="box-header" style="cursor: move;">
                        <!-- tools box -->
                        <div class="pull-right box-tools">
                            <button onclick="window.location.href = '/index.php?mod=laporan_db&amp;sub=dbTarunaNonDiklat&amp;act=view&amp;typ=html'" class="btn btn-primary btn-sm" data-toggle="tooltip" title="" data-original-title="Back">
                        ...
                        <i class="fa fa-table"></i>
                        <h3 class="box-title">
                            List Taruna Sekolah : <span class="keywordDetail"></span>
                        </h3>
                    </div><!-- /.box-header -->
                    <div class="box-body table-responsive">
