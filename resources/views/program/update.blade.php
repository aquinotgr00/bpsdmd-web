                    ...
                    <div class="box-body">
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group {{ $errors->has('vision') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="vision" name="vision" value="{{ $data->getVision() }}">
                            ...
                            <div class="form-group {{ $errors->has('mission') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="mission" name="mission" value="{{ $data->getMission() }}">
                            ...
                            <div class="form-group {{ $errors->has('passing_grade_credits') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" id="passing_grade_credits" name="passing_grade_credits" value="{{ $data->getPassingGradeCredits() }}">
                            ...
                            <div class="form-group {{ $errors->has('est_date') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="date form-control" id="est_date" name="est_date" value="{{ $data->getEstDate() instanceof \DateTime ? $data->getEstDate()->format('d-m-Y') : '' }}">
