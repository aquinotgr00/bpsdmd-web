...
class Diklat
{
     ...
     * @return Diklat[]
     */
    public function getDiklatByType($type = 'all')
    {
        if ($type == Diklat::TYPE_DPM) {
            return $this->getRepository()->findBy(['type' => Diklat::TYPE_DPM]);
        } elseif ($type == Diklat::TYPE_TEKNIS) {
            return $this->getRepository()->findBy(['type' => Diklat::TYPE_TEKNIS]);
        }
